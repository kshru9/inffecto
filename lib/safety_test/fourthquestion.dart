...
// class MyApp4 extends StatefulWidget {
//   static const String tag = "4q";
//   MyApp4({Key key, this.title, this.documentId}) : super(key: key);
//   final String title;
//   String documentId;
...
//     int count = document["count"] == null ? 0 : document["count"];
//     setState(() {
//       safetyCounter = count;
//     });
//   }

//   updateRatingToFirebase(List<String> currentLocation) async {
//     final firebaseUser = await FirebaseAuth.instance.currentUser();
//     final userId = firebaseUser.getIdToken().toString();
...
//   updateSafetyCounter(int counter) async {
//     final firebaseUser = await FirebaseAuth.instance.currentUser();
//     final userId = firebaseUser.getIdToken().toString();
//     await Firestore.instance.collection('users').document(userId).setData({"safetyCounter": counter},merge: true);
//   }
...
//                       title: "States",
//                       cities: f2.allStates,
//                       selectedCities: _selectedStates,
//                       onSelectedCitiesListChanged: (cities) {
//                         _selectedStates = cities;
//                       }
//                     );
//                   }
//                 );
...
//                   setCity(_selectedStates[0]);
//                 }
//                 setState(() {
//                   safetyCounter +=1;
//                 });
//                 updateSafetyCounter(safetyCounter);
//                 updateRatingToFirebase(_selectedStates);
//                 _getScore4();
//                 Navigator.of(context).pushNamed('submitpage');
//               },
//               child: Container(
