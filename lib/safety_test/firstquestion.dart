...
//   addRatingToFirebase(List<String> symp) async {
//     final firebaseUser = await FirebaseAuth.instance.currentUser();
//     final userId = firebaseUser.getIdToken().toString();
//     final documentId = Firestore.instance.collection('users').document(userId).collection('safetyTest').document().documentID;
//     setState(() {
//       _documentId = documentId;
//     });
//     await Firestore.instance.collection('users').document(userId).collection('safetyTest').document(documentId).setData({
//       "symptoms": symp,
//       "India travel": [],
//       "Foreign travel": "No",
//       "interaction" : [],
...
//               onTap: () {
//                 if(!fileDownloaded)networkHandler();
//                 addRatingToFirebase(symp);
//                 _getScore1();
//                 Navigator.push(context, MaterialPageRoute(builder: (context)=>MyApp2(documentId: _documentId,)));
//               },
//               child: Container(
//                 decoration: BoxDecoration(
//                   boxShadow: [
