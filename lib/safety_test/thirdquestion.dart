...
//   MyApp3({Key key, this.title, this.documentId}) : super(key: key);
//   final String title;
//   String documentId;
//   @override
//   _MyHomePageState createState() => _MyHomePageState();
...
//   updateRatingToFirebase(List<String> interaction) async {
...
//             InkWell(
//               onTap: (){
//                 updateRatingToFirebase(interaction);
//                 _getScore3();
//                 Navigator.push(context, MaterialPageRoute(builder: (context)=>MyApp4(documentId: widget.documentId,)));
//               },
//               child: Container(
//                 decoration: BoxDecoration(
//                   boxShadow: [
...
//   // Allocation of 30
//   double  ret = 0;
//   if(color1 == mytheme.accentColor) ret+=10;
//   if(color2 == mytheme.accentColor) ret+=20;
//   return score3 = ret; 
// }